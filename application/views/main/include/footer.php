 <footer class="main-footer hidden-xs">
        ...
        Copyright © 2020 <strong><a href="<?= base_url('admin'); ?>"><?=PROJECT_NAME;?></a>.</strong> All Rights Reserved | Created by SSAK Software Solutions
      </footer>
    </div><!-- ./wrapper -->
    ...
    <!-- jQuery UI 1.11.2 -->
    <script src="<?php echo base_url(); ?>assets/admin/other/jquery-ui.min.js" type="text/javascript"></script>
    ...
    <!-- Morris.js charts -->
    <script src="<?php echo base_url(); ?>assets/admin/other/raphael-min.js"></script>
    <!-- Sparkline -->
...
<script src="<?php echo base_url(); ?>assets/cmf/pluigin/dist/zoomify.js"></script>
