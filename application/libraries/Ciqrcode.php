...
class Ciqrcode
{
	...
	public function generate($params = array(),$qrData = array()) {
		$mmcId 				= $qrData['mmcId'];
		$addedByMobileNo 	= $qrData['addedByMobileNo'];
		$addedByName 		= $qrData['addedByName'];
		$masjid_name 		= $qrData['masjid_name'];
		$managedByMobileNo  = $qrData['managedByMobileNo'];
		$managedByName 		= $qrData['managedByName'];
		$presidentMobile 	= $qrData['presidentMobile'];
		$presidentName 		= $qrData['presidentName'];
		$secretaryMobileNo  = $qrData['secretaryMobileNo'];
		$secretaryName 		= $qrData['secretaryName'];
		$imamMobileNo 		= $qrData['imamMobileNo'];
		$imamName 			= $qrData['imamName'];
		$authorisedPersonMobile = $qrData['authorisedPersonMobile'];
		$authorisedPersonName 	= $qrData['authorisedPersonName'];
		$email 				= $qrData['email'];
		$pincode 			= $qrData['pincode'];
		$telephone_number 	= $qrData['telephone_number'];
		$post_office 		= $qrData['post_office'];
		$address 			= $qrData['address'];
		$googleAddress 		= $qrData['googleAddress'];
		$data = "MMCId : ".$mmcId."\r\n"."Masjid Name : ".$masjid_name ."\r\n"."Added By Name : ".$addedByName."\r\n"."Added By Mobile : ".$addedByMobileNo."\r\n"."Managed By Name : ".$managedByName."\r\n"."Managed By Mobile : ".$managedByMobileNo."\r\n"."Email : ".$email."\r\n"."Pincode : ".$pincode."\r\n"."Address : ".$googleAddress;
		...
		$params['data'] = (isset($params['data'])) ? $params['data'] :$data;
	...
	public function MadrasaGenerate($params = array(),$qrData = array()) {
		$mmcId 				= $qrData['mmcId'];
		$addedByMobileNo 	= $qrData['addedByMobileNo'];
		$addedByName 		= $qrData['addedByName'];
		$masjid_name 		= $qrData['madrasaName'];
		$managedByMobileNo  = $qrData['managedByMobileNo'];
		$managedByName 		= $qrData['managedByName'];
		$presidentMobile 	= $qrData['presidentMobile'];
		$presidentName 		= $qrData['presidentName'];
	...
	public function WakfGenerate($params = array(),$qrData = array()) {
		$mmcId 				= $qrData['mmcId'];
		$addedByMobileNo 	= $qrData['addedByMobileNo'];
		$addedByName 		= $qrData['addedByName'];
		$masjid_name 		= $qrData['wakfLocation'];
		$managedByMobileNo  = $qrData['managedByMobileNo'];
		$managedByName 		= $qrData['managedByName'];
		$presidentMobile 	= $qrData['presidentMobile'];
		$presidentName 		= $qrData['presidentName'];
	...
	function BusinessGenerate($params = array(),$qrData = array()){
		$mmcId 				= $qrData['mmcId'];
		$addedByMobileNo 	= $qrData['addedByMobileNo'];
		$addedByName 		= $qrData['addedByName'];
		$masjid_name 		= $qrData['madrasaName'];
		...
		$address 			= $qrData['address'];
		$googleAddress 		= $qrData['googleAddress'];
		$data = "MMCId : ".$mmcId."\r\n"."Business Name : ".$masjid_name ."\r\n"."Owner Name : ".$addedByName."\r\n"."Pincode : ".$pincode."\r\n";
		if (isset($params['black']) 
			&& is_array($params['black']) 
			&& count($params['black']) == 3 
			&& array_filter($params['black'], 'is_int') === $params['black']) {
